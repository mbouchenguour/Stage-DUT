...
const AddParticulier = (props) => {
 ...
 /**
  ...
  /**
   * Ajoute un particulier à la bdd lors de la validation du formulaire
   * @param {*Les données du particulier} data
   */
  const onSubmit = (data) => {
    axios
      .post("https://stage.hofmann.fr/sitereact/server/api/Particuliers.php", {
        data: data,
      })
      .then(() => {
        if (state.creation) {
  ...
  /**
   * Une page avec le formulaire d'ajout d'un particulier
   */
  return (
    <div className="ajout-particulier">
